    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.skuId) {
            this.$http({
              url: this.$http.adornUrl(`/gulimall_product/skuinfo/info/${this.dataForm.skuId}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/gulimall_product/skuinfo/${!this.dataForm.skuId ? 'save' : 'update'}`),
              method: 'post',
